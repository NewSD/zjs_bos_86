...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 关联客户窗口 -->
	<div class="easyui-window" title="关联客户窗口" modal="true"
			...
			<form id="customerForm"
				...
				<table class="table-edit" width="80%" align="center">
					<tr>
						...
						<td>已关联<br /> <select id="associationSelect"
							name="customerIds" multiple="multiple" size="10"></select>
						</td>
					</tr>
					<tr>
			...
			$(function() {
				...
				$("#associationBtn").click(
						function() {
							...
							$("#associationSelect option").attr("selected",
									"selected");
