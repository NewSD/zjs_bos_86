...
public class StaffAction extends BaseAction<Staff>{
	 ...
	 * 作废方法
	 */
	@RequiresPermissions("staff123")//必须具有staff-deltet权限，才能访问当前方法
	...
	public String findStaffByAjax(){
		...
		//QBC(面向对象) 对比  HQL(SQL)                                       001,002,003
		//select id,name from staff where deltag=0 and id not in(select staff_id from decidedzone)
